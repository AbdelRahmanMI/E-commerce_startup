...
@section('content')
                    ...
                    <div class="containerss">
                        <fieldset disabled>
                            <div class="col-md-12 mb-6">
                                ...
                                <input type="text" id="disabledTextInput" class="form-control" name="name" placeholder="Name Will Be Auto Added" >
                            </div>
                            <div class="col-md-12 mb-6">
                                <label for="disabledTextInput">Email</label>
                                <input type="text" id="disabledTextInput" class="form-control" name="email" placeholder="Email Will Be Auto Added" >
                            </div>
                        </fieldset>
                        <div class="col-md-12 mb-6">
                            <label for="">Phone Number</label>
                            <input type="text" class="form-control" name="phone" placeholder="This Can not be empty">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <label class="fw ">
                            ...
                            @endfor
                            @for($starsRemaning= number_format($average_rating)+1 ;$starsRemaning<=5 ; $starsRemaning++)
    ...
    <div class="text-center">
        <h4 style="font-size: 32px;" class="badge bg-success">Reviews</h4>
    </div>
        ...
        <div class="row">
            <div class="text-center">
                @foreach ($ratings as $item )
                    <div class="uesr-review">
                        <label for="">{{ $item->user->name }}</label>
                        <br>
                        @for ($starsChecked=1; $starsChecked<=$item->stars_rated ; $starsChecked++ )
                            <i class="fa fa-star checked"></i> 
                        @endfor
                        @for($starsRemaning= $item->stars_rated+1 ;$starsRemaning<=5 ; $starsRemaning++)
                            <i class="fa fa-star "></i> 
                        @endfor
                        <br>
