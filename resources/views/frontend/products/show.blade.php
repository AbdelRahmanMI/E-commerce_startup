                        ...
                        <div class="containerss">
                            <fieldset disabled>
                                <div class="col-md-12 mb-6">
                                    ...
                                    <input type="text" id="disabledTextInput" class="form-control" name="name" placeholder="{{ Auth::user()->name }}" >
                                </div>
                                <div class="col-md-12 mb-6">
                                    <label for="disabledTextInput">Email</label>
                                    <input type="text" id="disabledTextInput" class="form-control" name="email" placeholder="{{ Auth::user()->email }}" >
                                </div>
                            </fieldset>
                            <div class="col-md-12 mb-6">
